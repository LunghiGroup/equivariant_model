...
def parse_hyperparam(descr):
    ...
    parser.add_argument("-reg","--regularize", type=float, required=True, nargs='+', help="Regularization value")
...
def read_input(args):
    ...
    return [nsample,all_eles,full_ele_list,unique_ele,nspecies,natom,coords,bc,Nj,bispec_list,tens,l,rcut,reg,rank]
